//Используя полученные знания по обобщениям, сделайте код рабочим.
//  Дополнительное требование: классы, никак не связанные с Event, не должны работать с Registrable.
